...
export class CreateMeetingChannel {
  workspaceId: number;
  issuer: Issuer;
  ...
  constructor(partial: Partial<CreateMeetingChannel>) {
    patch(this, partial);
  }
}

@CommandHandler(CreateMeetingChannel)
export class CreateMeetingChannelCommand
  implements ICommandHandler<CreateMeetingChannel>
{
  constructor(
