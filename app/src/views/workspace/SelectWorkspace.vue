    ...
    <div class="signup w-xl h-full rounded-3xl flex:row-md p-xl">
        ...
        <div class="m-4xl">
          ...
          <div class="flex:col-3xl">
            ...
            <p class="headline_subtitle">
              Choose an existing workspace<br />
              or create a new one.
            </p>
          </div>
        </div>
      ...
      <section class="signup-form flex:col-7xl flex:center-y flex-1 mx-6xl">
        <div class="flex:col-xl">
          <h2 class="title text-foreground">Select or Create Workspace</h2>
          <div class="subtitle text-secondary-foreground">
            Choose an existing workspace or create a new one.
          </div>
        </div>

        <div class="flex:col-4xl w-full">
          ...
          <div class="flex:col-lg">
            ...
            <Combobox
              ...
              trigger-placeholder="Select workspace..."
              class="w-full"
            />
          ...
          <div class="flex:col-lg">
            <h3 class="text-lg font-semibold mb-2">Create New Workspace</h3>
            <Form
              class="flex:col-lg"
